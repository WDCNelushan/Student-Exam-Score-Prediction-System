...
st.markdown(
    ...
    .stApp .main .block-container { max-width: 1200px !important; margin: 0 auto !important; padding: 1.5rem 2rem 2.75rem !important; background: linear-gradient(180deg,#05081a,#081024) !important; }
    body { overflow-x: hidden !important; }
    .page-title { color: #f8fafc; font-size: 2.4rem; font-weight: 800; margin: 0; letter-spacing: -0.02em; }
    .page-subtitle { color: #b9c6d8; margin: 0.75rem 0 0; font-size: 0.98rem; max-width: 760px; white-space: normal; line-height: 1.7; }
    ...
    .section-card { background: rgba(12, 19, 37, 0.92); border-radius: 24px; padding: 1.5rem 1.75rem; border: 1px solid rgba(113, 105, 255, 0.18); box-shadow: 0 18px 50px rgba(0, 0, 0, 0.25); margin-bottom: 1.5rem; }
    .section-card h2 { margin: 0 0 0.75rem 0; font-size: 2rem; color: #ffffff; }
    ...
    .result-box { background: linear-gradient(180deg, rgba(15, 19, 36, 0.95) 0%, rgba(8, 16, 31, 0.98) 100%); border-radius: 24px; padding: 2rem 1.75rem; text-align: center; min-height: 240px; display: flex; flex-direction: column; align-items: center; justify-content: center; border: 1px solid rgba(56, 189, 248, 0.4); box-shadow: 0 0 40px rgba(56, 189, 248, 0.18), inset 0 0 18px rgba(255, 255, 255, 0.05); margin-top: 1.5rem; }
    .result-title { color: #a0c7f3; font-size: 0.85rem; letter-spacing: 0.3em; text-transform: uppercase; margin-bottom: 1rem; font-weight: 700; }
